...
function IconPartyPopper({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M15 2h.01" />
      <path d="M22 20h.01" />
      <path d="M22 2l-2.24.75a1 1 0 0 0-.36 1.67l1.18 1.18a1 1 0 0 0 1.67-.36L22 2Z" />
...
export default function LandingPage() {
  return (
    <div className="scanline-overlay relative overflow-hidden">
      {/* ── Background Layers ──────────────────────────────────── */}
      <div className="pointer-events-none fixed inset-0" aria-hidden="true">
        ...
        />
        {/* Ambient orbs */}
        <div className="absolute top-[15%] left-[10%] h-[500px] w-[500px] rounded-full bg-cyan-500/4 blur-[100px]" />
        <div className="absolute top-[60%] right-[5%] h-[400px] w-[400px] rounded-full bg-purple-500/4 blur-[100px]" />
        <div className="absolute bottom-[10%] left-[30%] h-[300px] w-[300px] rounded-full bg-green-500/3 blur-[100px]" />
      </div>
      ...
      <header className="sticky top-0 z-40 border-b border-white/5 bg-[#0a0a0f]/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          {/* Logo */}
          <Link href="/" className="group flex items-center gap-2.5" id="landing-logo">
            <Image
              src="/icon.svg"
              alt="Potdo"
              width={32}
          ...
          <nav className="hidden items-center gap-8 text-sm text-slate-400 md:flex">
            <a href="#features" className="transition-colors duration-200 hover:text-cyan-400">
              Features
            </a>
            <a href="#how-it-works" className="transition-colors duration-200 hover:text-cyan-400">
              How it Works
            </a>
            <a href="#faq" className="transition-colors duration-200 hover:text-cyan-400">
              FAQ
            </a>
          </nav>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden items-center gap-2 text-sm text-slate-400 transition-colors duration-200 hover:text-white sm:flex"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-cyan-500 px-5 py-2 text-sm font-semibold text-slate-950 transition-all duration-200 hover:bg-cyan-400 hover:shadow-lg hover:shadow-cyan-500/25"
            >
              Launch App
        ...
        <div className="mx-auto max-w-6xl px-6 py-12">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="max-w-sm text-sm leading-relaxed text-slate-500">
                ...
                Built for the DoraHacks Portaldot Online S1 Hackathon 2026.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm text-slate-500">
                ...
                <li>
                  <a href="#faq" className="transition-colors hover:text-cyan-400">
                    FAQ
                  </a>
                </li>
              </ul>
              ...
              <ul className="space-y-2.5 text-sm text-slate-500">
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 transition-colors hover:text-purple-400"
                  >
          ...
          <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-white/5 pt-6 sm:flex-row">
            ...
            <div className="flex items-center gap-4 text-xs text-slate-600">
              ...
              <a
                href="https://github.com/edycutjong/potdo/blob/main/SECURITY.md"
                target="_blank"
                rel="noopener noreferrer"
