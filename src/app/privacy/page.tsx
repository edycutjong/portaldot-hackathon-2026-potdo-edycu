...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for Potdo, the AI copilot for Portaldot blockchain transactions.",
};
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none" aria-hidden="true">
        ...
        />
        <div className="absolute top-[20%] left-[15%] w-[400px] h-[400px] bg-cyan-500/4 rounded-full blur-[100px]" />
        <div className="absolute bottom-[20%] right-[10%] w-[350px] h-[350px] bg-purple-500/3 rounded-full blur-[100px]" />
      </div>
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8">
          <section className="glass-card p-6 sm:p-8">
            <h2 className="text-lg font-semibold text-cyan-400 font-(family-name:--font-display) mb-3">
              1. Overview
            </h2>
            <p className="text-sm text-slate-400 leading-relaxed">
              Potdo (&quot;we,&quot; &quot;our,&quot; or &quot;the app&quot;) is
              an open-source AI copilot for the Portaldot blockchain, built for
              the DoraHacks Portaldot Online S1 Hackathon 2026. This Privacy
              Policy describes how we handle information when you use Potdo. We
            ...
            <ul className="space-y-2 text-sm text-slate-400 leading-relaxed">
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  — Potdo never accesses, stores, or transmits your private keys
                  or mnemonic seed phrases. All transaction signing happens
                  locally through your browser wallet extension.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5 shrink-0">✓</span>
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  — We do not use cookies, analytics trackers, advertising
            ...
            <ul className="space-y-2 text-sm text-slate-400 leading-relaxed">
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  — When you connect your wallet or query balances, your public
                  SS58 address is sent to the Portaldot RPC endpoint to fetch
                  on-chain data. This is publicly available blockchain data.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-400 mt-0.5 shrink-0">⚡</span>
                <span>
                  ...
                  — Your chat commands (e.g., &quot;Send 10 POT to Alice&quot;)
                  are parsed locally using our deterministic NLP engine. In demo
                  mode, no data leaves your browser. When the optional AI
                  backend is enabled, commands may be sent to OpenAI&apos;s API
                  for processing.
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  — When Supabase is configured, transaction metadata (command
                  text, tx hash, block number, status) may be stored for your
                  command history. This data is associated with your public
                  wallet address only.
                </span>
              </li>
            </ul>
              ...
              <table className="w-full text-sm text-slate-400">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="text-left py-2 pr-4 text-slate-300 font-medium">
                      Service
                    </th>
                    <th className="text-left py-2 pr-4 text-slate-300 font-medium">
                      Purpose
                ...
                <tbody className="divide-y divide-white/5">
                  <tr>
                    ...
                    <td className="py-2 pr-4">
                      On-chain queries &amp; transaction submission
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="py-2">
                      Only if Supabase keys are configured
                    </td>
                  </tr>
                  <tr>
          ...
          <section className="glass-card p-6 sm:p-8">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              By default, Potdo runs in{" "}
              <strong className="text-slate-200">demo mode</strong> with no
              external API connections. All data is generated locally with
              deterministic mock values. No data is transmitted to any server,
              no blockchain connections are made, and no third-party APIs are
              called. Demo mode is fully self-contained in your browser.
            </p>
          </section>
          ...
          <section className="glass-card p-6 sm:p-8">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Potdo is fully open source under the MIT License. You can audit
              ...
              . We encourage security researchers and developers to review our
              data handling practices directly in the source code.
            </p>
          </section>
